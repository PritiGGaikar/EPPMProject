...
if (WebUI.verifyElementVisible(findTestObject('Object Repository/Cost_Centre_Page/button_Update Search'))) {
    ...
    CustomKeywords.'com.eppm.keywords.TestBase.sendkeyElement'(findTestObject('Object Repository/Cost_Centre_Page/input_NameTxtBox'), 
        Name_Revert_Cost_Centre)

    'click on Inactive radio button'
    CustomKeywords.'com.eppm.keywords.TestBase.clickElement'(findTestObject('Object Repository/Cost_Centre_Page/radioButton_ Inactive'))

    'click on Revert botton'
    CustomKeywords.'com.eppm.keywords.TestBase.clickElement'(findTestObject('Object Repository/Cost_Centre_Page/button_Revert'))

    'click on cancel button'
    CustomKeywords.'com.eppm.keywords.TestBase.clickElement'(findTestObject('Object Repository/Cost_Centre_Page/button_Cancel'))
} else {
